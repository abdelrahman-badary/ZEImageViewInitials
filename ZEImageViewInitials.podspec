#
# Be sure to run `pod lib lint ZEImageViewInitials.podspec' to ensure this is a
...
TODO: This pod is a UIImageView category that enables users of it to create an imagView displaying letters.
  ...
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/ZEImageViewInitials.git', :tag => s.version.to_s }
